const PhoneSVG = ({
  ...
  <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 359 871">
    <g id="Full Style">
      <g id="Phone base">
        <path
          id="Antenna"
        ...
        ></path>
        <ellipse id="Ellipse 2" cx="178.634" cy="106.145" fill="#D6D3D3" rx="67.459" ry="21.047"></ellipse>
        <ellipse id="Ellipse 3" cx="178.633" cy="114.773" fill="#ADADAC" rx="11.333" ry="3.778"></ellipse>
        <ellipse
          id="Status light"
          fill="#949792"
          rx="16.175"
      ...
      <g id="Keypad" style={{ mixBlendMode: "hard-light" }} onClick={(e) => handleNumKeyPress(e)}>
      ...
      <g id="Link Buttons">
        <g id="instagram" className={startingUp ? "boot-button-gummy" : "button"} onClick={(e) => handleLinkPress(e)}>
          <g id="instagram">
          ...
          <g id="instagram" fill="#616161" clipPath="url(#clip0)">
            ...
            ></path>
            <path id="instagram" d="M97.748 559.333a1.012 1.012 0 100-2.024 1.012 1.012 0 000 2.024z"></path>
          </g>
        </g>
        <g id="email" className={startingUp ? "boot-button-gummy" : "button"} onClick={(e) => handleLinkPress(e)}>
          <g id="email">
        ...
        <g id="website" className={startingUp ? "boot-button-gummy" : "button"} onClick={(e) => handleLinkPress(e)}>
          <g id="website">
        ...
        <g id="back" className={startingUp ? "boot-button-gummy" : "button"} onClick={handleBackspacePress}>
          <g id="Ellipse 21">
      ...
      <g id="Control Buttons">
        <g id="camera" className="button" onClick={handleCameraPress}>
          ...
          <g id="noun_Camera_78831 1" fill="#000">
            <path id="Vector_7" d="M179.711 530.256a6.12 6.12 0 100-12.24 6.12 6.12 0 000 12.24z"></path>
            <path
              id="Vector_8"
        ...
        <g id="ok" className="button" onClick={handleOkPress}>
          <path
            id="Rectangle 16"
            fill="#FDFDFD"
        ...
        <g id="cancel" className="button" onClick={handleCancelPress}>
          <path
            id="Rectangle 11"
            fill="#FDFDFD"
          ...
          <g id="noun_Hang Up_5012 2" fill="#D04033" clipPath="url(#clip3)">
            ...
            ></path>
            <path id="Vector_11" d="M276.344 517.115h-3.275v4.108h-2.457l4.083 7.071 4.084-7.071h-2.435v-4.108z"></path>
          </g>
        </g>
      </g>
      <g id="Screen Frame">
        ...
        <rect id="screen backdrop" width="263.361" height="259.043" x="48" y="200" fill="#BEBEBE" rx="7"></rect>
        <rect id="screenedge" width="249.912" height="243.741" x="55" y="208" rx="2" ref={bboxRef}></rect>
      </g>
    </g>
    <defs>
      <radialGradient
      ...
      <clipPath id="clip0">
        <path fill="#fff" d="M0 0H16.19V16.19H0z" transform="translate(85.268 554.611)"></path>
      </clipPath>
      <clipPath id="clip1">
        <path fill="#fff" d="M0 0H18.349V22.019H0z" transform="translate(141.393 572.96)"></path>
      </clipPath>
      <clipPath id="clip2">
        <path fill="#fff" d="M0 0H21.587V21.587H0z" transform="rotate(-96 276.903 229.809)"></path>
      </clipPath>
      <clipPath id="clip3">
        <path fill="#fff" d="M0 0H26.984V26.984H0z" transform="translate(261.202 504.961)"></path>
      </clipPath>
    </defs>
  </svg>
);
